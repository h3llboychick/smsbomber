...
class Ponyexpress(Service):
	...
	async def send_one(self, phone, session):
		data = {"name":"xdxd","middlename":"xdxd","surname":"xdxd","phone": self.format_number(phone),"email":"lerib61278@fulwark.com","pass":"qH!Zg7dGp6PCTY2","passRepeat":"qH!Zg7dGp6PCTY2","agree":"true"}
		status, text = await self.make_request(session, url = "https://lk.ponyexpress.ru/api/v1/resendCode", json = data)	
		return (status, text)
	@classmethod	
		async with aiohttp.ClientSession() as session:
			status, text = await self.make_request(session, url = "https://lk.ponyexpress.ru/api/v1/createuser", json = {"name":"xdxd","middlename":"xdxd","surname":"xdxd","phone":self.format_number(phone),"email":"lerib61278@fulwark.com","pass":"qH!Zg7dGp6PCTY2","passRepeat":"qH!Zg7dGp6PCTY2","agree":"true"})
			print(text)
...
if __name__ == "__main__":
	...
	asyncio.get_event_loop().run_until_complete(Ponyexpress.send_sms("+77071080866"))